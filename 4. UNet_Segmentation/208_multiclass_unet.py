from _simple_multi_unet_208 import multi_unet_model  # Uses softmax
...
#patchify: 이미지를 작고 겹칠 수 있는 패치로 분할 하고 패치를 원래 이미지로 다시 병합하는데 도움이 되는 라이브러리
...
reconstructed_image = unpatchify(predicted_patches_reshaped, large_image.shape)#original shape
