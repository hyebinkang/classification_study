...
df = dataframe[['Date', 'Close']]           #Date, Close 만 가져오기
...
train, test = df.loc[df['Date'] <= '2023-01-25'], df.loc[df['Date'] > '2023-01-25']
...
scaler = StandardScaler()                   #평균을 제거하고 단위 분산으로 스케일링하여 기능 표준화
...
seq_size = 30  # Number of time steps to look back-> training sequence size
