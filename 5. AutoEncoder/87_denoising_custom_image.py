...
from tqdm import tqdm               #visual representation of things happening inside

noisy_data = []
path1 = '../1_ImagePreProcessing/cell_images/Parasitized'
...
clean_data = []
path2 = '../1_ImagePreProcessing/cell_images/Uninfected'
